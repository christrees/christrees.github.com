...
I'm not a fan of the traditional resume and interview process, but a huge fan of process documentation followed pull requests generated from user feedback.  So I will combine a chore I dred (resume update) with a process I welcome (user feedback and pull requests).  Meet the Chris Trees Resume GitHub project with subject based YouTube instructional interviews.
